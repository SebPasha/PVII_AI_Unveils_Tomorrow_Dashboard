...
Generated 2026-08-15 15:15 by run_pipeline.py

| Stage | Ran | Key QA |
|---|---|---|
| validate_stage_schema (L2) | ok | QA FAIL - FAIL 1/6 (bhutan_strategyclean.xlsx) |
...
```
--- bhutan references
RESULT: PASS - every one of 378 reference(s) resolves
...
### build_final_panel
```
ERROR: no mapping rows. Checked --mapping-dir '/Users/sebastianpasha/Developer/Environment_UNDP/PV2/Files/llm/bhutan/mappings' and --mapping None.
